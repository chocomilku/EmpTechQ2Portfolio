...
_An ICT Project is just a project with ICT involved in it. Every Projects need feedback in order to improve the experience the target audience wants. With some ICT Tools, you can evaluate your project to know some vital information that will be helpful for your project._